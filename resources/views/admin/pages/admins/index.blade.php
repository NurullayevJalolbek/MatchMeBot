        ...
        <div class="col-12">
            <div class="card stretch stretch-full">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <h5 class="card-title mb-0">Adminlar Ro'yxati</h5>
                    <div class="card-header-action d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.admins.create') }}" class="btn btn-primary btn-sm px-3">
                            <i class="feather-plus me-1"></i> Qo'shish
                        </a>
                    </div>
                </div>
                <div class="card-body custom-card-action p-0">
                    @include('admin.pages.admins._columns', ['datas' => $admins ?? $datas])
                </div>
...
<script>
    (function ($) {
        ...
        $(document).on('click', '.btn-delete', function (e) {
            ...
            const message = $btn.data('message') || $btn.attr('data-message') || "Haqiqatan ham ushbu Administratorni o'chirmoqchimisiz?";
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response && response.success) {
                                Toast.fire({
                                    icon: 'success',
                                    title: response.message || "Administrator muvaffaqiyatli o'chirildi!"
                                });
